...
const addLog = async (eventType, actor, description, detailsObj) => {
  await db.query(
    'INSERT INTO logs (event_type, actor, description, details) VALUES ($1, $2, $3, $4)',
    [eventType, actor, description, JSON.stringify(detailsObj)]
  );
};
